export const infoAgency = {
    name: 'Nicoletta Pelosi',
    role: 'Digital Designer & Frontend Developer',
    email: 'pelosinicoletta@gmail.com',
    agency: 'Klyk Studio',
    emailAgency: 'klyk.studio@gmail.com',
    phone: '+39 334 119 59 25',
    location: 'Remote, Italy',
    socialMedia: {
        linkedin: 'https://www.linkedin.com/in/nicoletta-pelosi/',
        instagram: 'https://www.instagram.com/klyk.studio/',
        behance: 'https://www.behance.net/klykstudio',
        github: ''
    },
    ...
    Products: 'You can see some of our works.',
};
...
export const infoDesigner = [
    {
        ...
        socialMedia: {
            linkedin: 'https://www.linkedin.com/in/nicoletta-pelosi/',
            instagram: 'https://www.instagram.com/klyk.studio/',
            portfolio: 'https://www.behance.net/klykstudio',
        }
    },
    {
        id: 2,
        name: 'Alessandro Pelosi',
        role: 'Graphic Designer & Illustrator',
        email: 'alessandro@example.com',
        designerImage: '',
        socialMedia: {
            linkedin: 'https://www.linkedin.com/in/alessandro-pelosi/',
            instagram: 'https://www.instagram.com/alessandro.illustrator/',
            portfolio: 'https://www.behance.net/alessandropelosi',
        }
    }
]
